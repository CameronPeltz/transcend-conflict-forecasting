...
FEATURE_SETS = {
    ...
    "plus_chirps": ROUND3_COMBINED + ["chirps_rainfall_mm"],
}
...
if __name__ == "__main__":
    df = pd.read_csv("../data/discrete_event_candidates_v5.csv", parse_dates=["issue_date"])
    ...
    with open("../results/chirps_results.json", "w", encoding="utf-8") as f:
        json.dump(out, f, indent=2, default=str)
    print("Saved ../results/chirps_results.json")
